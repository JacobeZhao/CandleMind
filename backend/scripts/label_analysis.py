...
用法:
  python scripts/label_analysis.py              # 默认 BTCUSDT
  python scripts/label_analysis.py --symbol BNBUSDT
  python scripts/label_analysis.py --symbol all  # 所有币种
...
def load_labels(sym: str) -> pd.DataFrame:
    path = MARKET_ROOT / 'labels' / f'{sym}_5m_labels.parquet'
