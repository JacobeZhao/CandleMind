...
用法:
  python scripts/market_analysis.py              # 默认 BTCUSDT, 全部分析
  python scripts/market_analysis.py --symbol BNBUSDT
  python scripts/market_analysis.py --phase1     # 仅 Part 1 (特征分布)
  python scripts/market_analysis.py --phase2     # 仅 Part 2 (深度对比)
...
def part2(sym: str):
    ...
    if sym != 'BNBUSDT':
        ...
        try:
            ...
            bnb_feat_path  = MARKET_ROOT / 'features_ml' / 'BNBUSDT_features.parquet'
            bnb_label_path = MARKET_ROOT / 'labels' / 'BNBUSDT_5m_labels.parquet'
